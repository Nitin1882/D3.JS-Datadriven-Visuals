...
let chosenXAxis = 'bottom_salinity_psu';
let chosenYAxis =  'top_bottom_coliform_cells_100_ml';
...
function styleX(value, chosenXAxis) {
    ...
    if (chosenXAxis === 'top_ammonium_mg_l') {
        return `${value}`;
    }
...
function styleY(value, chosenYAxis) {
  ...
  if (chosenYAxis === 'top_bottom_coliform_cells_100_ml') {
      return `${value}`;
  }
...
function updateToolTip(chosenXAxis, chosenYAxis, circlesGroup) {
  ...
  if (chosenYAxis ==='oxidation_reduction_potential_mv_bottom_sample') {
    ...
    var yLabel = 'top_bottom_coliform_cells_100_ml:';
  }
...
d3.csv('./assets/data/data.csv').then(function(nycData) {
    ...
    var top_ammonium_mg_l = xLabelsGroup.append('text')
      .classed('aText', true)
      .classed('active', true)
      .attr('x', 0)
      .attr('y', 20)
    ...
    var top_bottom_coliform_cells_100_ml = yLabelsGroup.append('text')
      .classed('aText', true)
      .classed('inactive', true)
      .attr('x', 0)
      .attr('y', 0 - 80)
      ...
      .on('click', function() {
        ...
        if(value !=chosenYAxis) {
            ...
            if (chosenYAxis === 'oxidation_reduction_potential_mv_top_sample') {
              ...
              top_bottom_coliform_cells_100_ml.classed('active', false).classed('inactive', true);
            }
            else if (chosenYAxis === 'oakwood_bod_top_sample_mg_l') {
              ...
              oxidation_reduction_potential_mv_bottom_sample.classed('active', false).classed('inactive', true);
              oakwood_bod_top_sample_mg_l.classed('active', false).classed('inactive', true);
              top_bottom_coliform_cells_100_ml.classed('active', true).classed('inactive', false);
            }
          }
        });
});