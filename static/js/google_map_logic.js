...
function initMap() {
  ...
  console.log("Loaded Map object");
  console.log(map);

  // map.data.loadJson('https://data.cityofnewyork.us/resource/5uug-f49n.json');
  map.data.setStyle({
    strokeColor: 'white',
    fillColor: 'black',
    fillOpacity: 0.3
...
function new_datapoints() {
  d3.json('/get_data').then( process_results(results));
}

function old_dataPoints() {
