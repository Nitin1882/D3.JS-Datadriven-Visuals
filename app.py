...
def d3jsproject_harborwatersample():
    ...
    for harborwater in harborwatersample:
        json_harborwatersample.append(harborwater)
    json_harborwatersample = json.dumps(
        json_harborwatersample, default=json_util.default)
    connection.close()
